...
const FunFact = () => {
  ...
  return (
    ...
    >
      <motion.div 
      className='h-screen mx-auto flex flex-col items-center bg-[#faeadc] sticky top-0 '
      style={{
      ...
      >
        <div className='flex h-full flex-col items-center space-y-20 justify-between py-24 px-4 max-w-[1024px]'>
        <motion.div 
        ...
        <div className="relative ">
          ...
          >
            <p className="text-center font-champBlack text-3xl text-brand-black sm:text-4xl max-w-3xl">
              The man who builds his idea is the man who actually has an idea.
        ...
        <div className='flex items-center gap-x-6 self-end pb-8 text-brand-black'>
          ...
          >
            <p className='text-xs sm:text-sm font-semibold'>Sun Tzu</p>
            <p className='text-[10px] sm:text-xs '>The Author of the  Art<br/> of War</p>
          </motion.div>
          <Image 
            src={Images.Suntzu}
            width={48}
